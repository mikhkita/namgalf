	...
	<div class="b-overflow">
		<div class="b b-1">
			<div class="b-block b-header">
				...
				<h1 class="anim fadeDown">Как стабильно получать <b>платёжеспособных клиентов</b> из Интернета и обогнать<br>рынок на 3-5 лет?</h1>
				...
				<div class="anim fadeDown delay400">
					<a href="#b-quiz-popup" class="b-btn b-green-btn b-quiz-link" id="b-quiz-payback"><span>Рассчитать окупаемость</span></a>
				</div>
			...
			<div class="b-block b-top-surgay clearfix">
				<div class="b-right right">
					...
					<h2><b>Здравствуйте. </b><br>Мы помогаем бизнесу становиться на порядок эффективнее и прибыльнее</h2>
					<div class="b-right-padding">
						<h3>Мы не продаем лендинг или трафик.<span class="thin"> Мы предлагаем достижение Ваших бизнес-целей, </span> <b>комплексно влияя 
							<div class="b-20-indexes">
								<a href="#b-indexes-popup" class="fancy">более чем на 10 показателей.</a>
							</div></b>
							<span class="thin">Вся команда засучив рукава полгода будет работать над Вашим проектом. Вы получаете:</span>
						</h3>
						<div class="b-indicators">
							<div class="b-indicators__item fadeRight anim" data-cont=".b-indicators">
								...
								<h4>от 10 до 800 заявок в сутки</h4>
							</div>
		...
		<div class="b b-3">
			...
			<div class="b-levels-slider">
				<div class="b-levels-slide">
					<div class="b-block">
						<div class="b-levels-image" style="background-image: url('i/mobile/4/doc-1.jpg')"></div>
						<h4 class="b-levels-text b-levels-text-1">С «информационных» запросов цепляем утепляющими квиз-лендингами. Их эффективность до 6 раз выше стандартных Landing Page</h4>
					</div>
				</div>
				<div class="b-levels-slide">
					<div class="b-block">
						<div class="b-levels-image" style="background-image: url('i/mobile/4/doc-2.jpg')"></div>
						<h4 class="b-levels-text b-levels-text-2">«Горячий» трафик ведем на основной «лендинг-атлант» с высокой конверсией</h4>
					</div>
				</div>
				<div class="b-levels-slide">
					<div class="b-block">
						<div class="b-levels-image" style="background-image: url('i/mobile/4/doc-3.jpg')"></div>
						<h4 class="b-levels-text b-levels-text-3">Тех, кто ушел, догоняем ретаргетингом с ценными лидмагнитами</h4>
					</div>
				</div>
			</div>
			<div class="b-block">
				<h3 class="b-levels-email anim fadeDown"><img src="i/3/mail.svg" alt="">Всех, кто попал в базу, <b>автоматически «прогреваем»</b> и «дожимаем» через email-рассылки, <b>мессенджеры</b> и SMS</h3>
			</div>
		</div>
		<div class="b b-4">
			<div class="b-block">
				...
				<h2 class="b-second-title"><b>Даем</b> точно то,<br> что искали</h2>
				<h4>Четко простраиваем каждое звено в цепочке  «запрос — объявление — сайт». В результате получаем до сотни связок. <br><strong>Например:</strong></h4>
			</div>
			<div class="b-give-slider">
				<div class="b-give-slide">
					<div class="b-block">
						...
						<div class="b-blank" style="background-image: url('i/4/blank-1.png'); background-size: contain;"><h4 class="b-label">Объявление</h4></div>
				...
				<div class="b-give-slide">
					<div class="b-block">
						...
						<div class="b-blank" style="background-image: url('i/4/blank-2.png'); background-size: contain;"><h4 class="b-label">Объявление</h4></div>
				...
				<div class="b-give-slide">
					<div class="b-block">
						...
						<div class="b-blank" style="background-image: url('i/4/blank-3.png'); background-size: contain;"><h4 class="b-label">Объявление</h4></div>
						<div class="b-ipad" style="background-image: url('i/4/ipad-3.jpg');"></div>
					</div>
				</div>
			</div>
			<p class="b-give-text"><strong>И так по всем запросам, </strong>чтобы выжать максимум из каждого рубля рекламного бюджета</p>
		</div>
		<div class="b b-5">
			<div class="b-block">
		...
		<div class="b b-6">
			<div class="b-block">
				<h2><b>Ведем</b> умную<br> Email-рассылку<span class="b-svg-mail"></span></h2>
				<h4>Разрабатываем ее для каждого сегмента,  а не «стреляем <b>пушкой по воробьям<br><strong>Например:</strong></h4>
				<div class="b-three-blocks justify" id="b-three-blocks-1">
					<div class="b-three-block fadeDown anim" data-cont="#b-three-blocks-1">
						...
						<h4><b>Пришел «просто узнать»</b> Прогреваем, показываем экспертность, создаем и усиливаем доверие</h4>
					</div>
					<div class="b-three-block fadeDown delay200 anim" data-cont="#b-three-blocks-1">
						<img src="i/6/pic-2.jpg" alt="">
						<h4><b>Точно заинтересован</b> Сразу показываем выгоды работы с вами, преимущества товара, отзывы</h4>
					</div>
					<div class="b-three-block fadeDown delay400 anim" data-cont="#b-three-blocks-1">
						<img src="i/6/pic-3.jpg" alt="">
						<h4><b>Не достаточно мотивации</b> Делаем рассылку с акциями, индивидуальными предложениями</h4>
					</div>
				</div>
		...
		<div class="b b-7 black">
			...
			<div class="b-block b-first-result">
				...
				<div class="b-results">
					...
					<h3 class="icon-monitor anim fadeDown delay400" data-cont=".b-results">Все обращения станут более теплыми, потому что будет готов основной сайт.</h3>
				</div>
			</div>
			<div class="b-block b-system">
				<h2><b>Через полгода</b> у вас будет примерно такая система</h2>
				<div class="b-scheme">
					<h4 class="icon-quote">В реальности она гораздо<br>сложнее. Сейчас мы даем вам лишь<br>общее понимание масштаба<span class="b-line"></span></h4>
		...
		<div class="b b-8">
			<div class="b-block">
				...
				<div class="b-how-much-slider">
					<div class="b-how-much-slide">
						<div class="b-note b-vertical-form b-form-1">
							<div class="b-border">
								<h2 class="anim fadeRight" data-cont=".b-form-1">Самые платежеспособные клиенты <b>хотят купить</b> прямо сейчас</h2>
								<p class="anim fadeRight delay200" data-cont=".b-form-1">Таких не нужно прогревать, убеждать, мотивировать скидками. Они просто приходят, чтобы отдать вам деньги.</p>
								<img src="i/8/image-1.jpg" class="anim fadeRight delay400" data-cont=".b-form-1">
							</div>
							<div class="b-note-shadow"></div>
						</div>
					</div>
					<div class="b-how-much-slide">
						<div class="b-note b-vertical-form b-form-2">
							<div class="b-border">
								<h2 class="anim fadeRight" data-cont=".b-form-2"><b>Регулируйте</b> поток клиентов буквально в один клик</h2>
								<p class="anim fadeRight delay200" data-cont=".b-form-2">Увеличили рекламный бюджет — заявок стало больше. Не справляетесь с наплывом? Приостановили рекламу или уменьшили бюджет. </p>
								<img src="i/8/image-2.jpg" class="anim fadeRight delay400" data-cont=".b-form-2">
							</div>
							<div class="b-note-shadow"></div>
						</div>
					</div>
					<div class="b-how-much-slide">
						<div class="b-note b-vertical-form b-form-3">
							<div class="b-border">
								<h2 class="anim fadeRight" data-cont=".b-form-3">Вложились в систему<b> один раз</b> — и она работает на вас<br> 5-6 лет</h2>
								<p class="anim fadeRight delay200" data-cont=".b-form-3">Все настолько автоматизировано и выверено. Есть только один вопрос «Сколько клиентов я могу обработать?»</p>
								<img src="i/8/image-3.jpg" class="anim fadeRight delay400" data-cont=".b-form-3">
							</div>
							<div class="b-note-shadow"></div>
						</div>
					</div>
					<div class="b-how-much-slide">
						<div class="b-note b-vertical-form b-form-4">
							<div class="b-border">
								<h2 class="anim fadeRight" data-cont=".b-form-4"><b>Занимаетесь</b> тем, что действительно важно</h2>
								<p class="anim fadeRight delay200" data-cont=".b-form-4">Маркетинг больше не отвлекает вас от бизнеса. Вы можете сосредоточиться на масштабировании, диферсификации, выходе на новые рынки.</p>
								<img src="i/8/image-4.jpg" class="anim fadeRight delay400" data-cont=".b-form-4">
							</div>
							<div class="b-note-shadow"></div>
						</div>
					</div>
					<div class="b-how-much-slide">
						<div class="b-note b-vertical-form b-form-5">
							<div class="b-border">
								<h2 class="anim fadeRight" data-cont=".b-form-5"><b>Вы — №1</b> в глазах клиентов</h2>
								<p class="anim fadeRight delay200" data-cont=".b-form-5">За счет визуальной упаковки, донесения правильных смыслов и продуманной работы с платёжеспособными сегментами целевой аудитории.</p>
								<img src="i/8/image-5.jpg" class="anim fadeRight delay400" data-cont=".b-form-5">
							</div>
							<div class="b-note-shadow"></div>	
						</div>
					</div>
		...
		<div class="b b-10">
			<div class="b-block">
				<h2>Вы получите <b>Road map</b> по вашему проекту на 3-<nobr>й</nobr> неделе работы</h2>
				<h3 id="legend-start">Так вы сможете планировать свое время и четко понимать, когда и какие ресурсы понадобятся. В результате взаимодействие идет в 2-3 раза эффективнее</h3>
				<div class="b-timetable-cont clearfix">
					<div class="b-legend left anim legendAnim" data-cont=".b-10" data-offset="300">
		...
		<div class="b b-12 black">
			...
			<div class="b-works-slider">
				<div class="b-works-slide">
					<div class="b-block">
						<div class="b-text">							
							<h3 class=""><b>Привлекли</b> Транснефть, Крост и свыше 140 млн рублей с помощью 1-го Landing Page</h3>
							<p class="">Провели глубокий анализ 9 целевых аудиторий. 4 рабочих дня мы провели в офисе Клиента, чтобы изучить компанию и разговаривать с аудиторией на профессиональном языке.</p>
							<div class="b-expand-description">
								<p>
									Разработали 4 концепции прототипа. Донесли преимущества через подход к работе, организовав фото- и видеосъемку этапов работ. Premium-дизайн позволил привлекать самых платежеспособных и интересных Заказчиков.<br><br> В результате группа инженеров стала очень конкурентоспособной компанией, выиграла целый ряд тендеров.
								</p>
 							</div>
 							<a href="" class="expander show-ex"><p>Подробнее</p></a>
 							<div class="b-logo-container">
								<img class="works-img-1 " src="i/17/logo-1.jpg">
								<div class="slider-logo-text">Освещение элитной<br> недвижимости</div>
							</div>
				...
				<div class="b-works-slide">
					<div class="b-block">
						<div class="b-text">
							<h3 class=""><b>Создали</b> систему привлечения клиентов из 3-х Landing Page и вдохнули в бренд новую жизнь</h3>
							<p class="">«Не было ни одного дня без клиентов» — говорит Заказчик. Запустили мультилендинги, quiz, e-mail рассылку и оформили социальные сети. Ежемесячно оптимизируем таргетированную и контекстную рекламу.</p>
							<a href="" class="expander show-ex"><p>Подробнее</p></a>
							<div class="b-expand-description">
								<p>	
									Один из самых ярких наших проектов! Создали мощную платформу для бренда 2D School. Невероятный сайт, логотип, продающее видео. И самое главное — ежедневно эта система приносит прибыль.
	 							</p>
	 						</div>
	 						<div class="b-logo-container">
								<img class="works-img-2 " src="i/17/logo-2.jpg">
								<div class="slider-logo-text">Школа современных<br> танцев для детей</div>
							</div>
							<!-- <h4 class="slider-anim duration500 fadeDown delay400"><a href="#">Читать кейс полностью</a></h4> -->
						</div>
				...
				<div class="b-works-slide">
					<div class="b-block">
						<div class="b-text">
							<h3><b>Увеличили</b> прибыль на 290%, так что заказчику пришлось нанять целый штат из 10 мастеров</h3>
							<p>Разработали мультилендинг более чем со 150 вариациями подстройки под запрос. Запустили свыше 40 рекламных кампаний в Яндекс Директ и Google Adwords. Сегментировали запросы по брендам, целевым и околоцелевым.</p>
									<div class="b-expand-description">
									<p>Интегрировали сайт с Bitrix24, так что 100% заявок без потерь попадают в воронку продаж. Автоматическая постановка задачи менеджерам при поступлении новых заявок с сайта.<br><br>Провели 6 полноценных А/В-тестов сайта, что позволило увеличить прибыль на 290% за 2&nbsp;месяца после запуска сайта.</p>
									</div>
									<a href="" class="expander show-ex"><p>Подробнее</p></a>
 							<div class="b-logo-container">
								<img class="works-img-3" src="i/17/logo-3.jpg">
								<div class="slider-logo-text">Немецкий чип-тюнинг<br> в Москве</div>
							</div>
							<!-- <h4 class="slider-anim duration500 fadeDown delay400"><a href="#">Читать кейс полностью</a></h4> -->
						</div>
					...
					<div class="b-block">
						<div class="b-text">
							...
							<div class="b-expand-description">
 							...
 							<div class="b-logo-container">
								<img class="works-img-4" src="i/17/logo-4.jpg">
								<div class="slider-logo-text">Языковая<br> школа в Москве</div>
							</div>
							<!-- <h4 class="slider-anim duration500 fadeDown delay400"><a href="#">Читать кейс полностью</a></h4> -->
						</div>
				...
				<div class="b-works-slide">
					<div class="b-block">
						<div class="b-text">
							<h3 class=""><b>Увеличили</b> прибыль на 290%, так что заказчику пришлось нанять целый штат из 10 мастеров</h3>
							<p class="">Разработали мультилендинг более чем со 150 вариациями подстройки под запрос. Запустили свыше 40 рекламных кампаний в Яндекс Директ и Google Adwords. Сегментировали запросы по брендам, целевым и околоцелевым.</p>
								<a href="" class="expander show-ex"><p>Подробнее</p></a>
									<div class="b-expand-description">
									<p>Интегрировали сайт с Bitrix24, так что 100% заявок без потерь попадают в воронку продаж. Автоматическая постановка задачи менеджерам при поступлении новых заявок с сайта.<br><br>Провели 6 полноценных А/В-тестов сайта, что позволило увеличить прибыль на 290% за 2&nbsp;месяца после запуска сайта.</p>
									</div>
 							<div class="b-logo-container">
								<img class="works-img-5" src="i/17/logo-5.jpg">
								<div class="slider-logo-text">Комплексное<br> ипотечное<br> страхование</div>
							</div>
							<!-- <h4 class="slider-anim duration500 fadeDown delay400"><a href="#">Читать кейс полностью</a></h4> -->
						</div>
					...
					<div class="b-block">
						<div class="b-text">
							...
							<div class="b-expand-description">
 							...
 							<div class="b-logo-container">
								<img class="works-img-6" src="i/17/logo-6.jpg">
								<div class="slider-logo-text">Оптовая продажа<br> сублимированного<br> растворимого кофе</div>
							</div>
							<!-- <h4 class="slider-anim duration500 fadeDown delay400"><a href="#">Читать кейс полностью</a></h4> -->
						</div>
					...
					<div class="b-block">
						<div class="b-text">
							...
							<a href="#" class="expander show-ex"><p>Подробнее</p></a>
 							...
 							<div class="b-logo-container">
								<img class="works-img-7" src="i/17/logo-5.jpg">
								<div class="slider-logo-text">Организация<br> и страхование<br> родов</div>
							</div>
							<!-- <h4 class="slider-anim duration500 fadeDown delay400"><a href="#">Читать кейс полностью</a></h4> -->
						</div>
		...
		<div class="b b-14">
				...
				<div class="b-directors">
					<div class="b-director clearfix">
						...
						<div class="b-director-text right b-director-text-1">
							<h2><b>Скорее всего,</b><br>через полгода вы решите запускать с нами ещё одно направление</h2>
					...
					<div class="b-director clearfix">
						<div class="b-director-text left b-director-text-2">
							<h2><b>Цена полной <br>6-месячной трансформации</b> <!-- <span class="b-svg-rubles"></span> --> начинается <br>от 590 т. р.</h2>
			...
			<div class="b-white-back">
				<div class="b-block">
					<div class="b-note b-vertical-form">
						<div class="b-border">
							<!-- <div class="b-img"></div> -->
							<h2><b>Узнайте</b> точную стоимость вашего проекта</h2>
							<p>Ответьте на несколько вопросов.<br> Вы получите 3 варианта по ценам в ближайшие день-два</p>
			...
			<div class="b-block">
				...
				<div class="b-text" data-offset="400">
					...
					<div class="b-item icon-screen-vertical anim fadeDown delay400" data-cont=".b-15 .b-text">
						<h3>Все зафиксировано в <b><a href="#">договоре</a></b></h3>
				...
				<div class="b-strong-price">
					...
					<h4>Только если вы решите внести что-то, чего не было в договоре. Например, всё-таки согласитесь, что вам нужна профессиональная фотосъемка, а раньше считали, что обойдетесь тем, что есть</h4>
				</div>
			</div>
		</div>
		<div class="b b-16">
			<div class="b-block">
				<div class="b-note b-vertical-form">
					<div class="b-border">
						...
						<h2><b>Три варианта</b> по составу инстру&shy;ментов, срокам и цене</h2>
...
<!-- 		<div class="b b-17">
		...
		<!-- <div class="b b-18">
			...
			<div class="b-three-items three-slide">
				<div class="b-three-item">
					<div class="b-block">
		...
		<div class="b b-19">
			<div class="b-block">
				<p class="b-first-p">Нам интересно делать только wow-кейсы. Мы всей командой буквально пашем ради этого. <strong>Поэтому берем только 9-10 проектов в год</strong></p>
					...
					<div class="b-note b-vertical-form right">
						<div class="b-border">
							...
							<form action="thanks.php" method="POST">
								...
								<input type="tel" name="phone" class="b-phone-input" placeholder="Введите номер телефона" required>
								<input type="text" name="email" class="b-email-input" placeholder="Введите ваш E-mail" required>
			...
			<div class="b-block">
				<div class="clearfix">
					<div class="b-text left">
						...
						<h4><b>Среднее время ответа:<br></b> 4 минуты в рабочее время</h4>
					</div>
	...
	<div style="display:none;">
			...
			<div class="b-border">
				...
				<form action="thanks.php" method="POST" data-goal="CALLBACK" method="POST" id="b-form-1" class="email-form">
					<div class="b-popup-form">
						...
						<a href="#" class="b-btn b-green-btn ajax"><span>Скачать план бесплатно</span></a>
						<small>Нажимая на кнопку, вы даете согласие на обработку своих персональных данных и соглашаетесь с<br><a href="#">Политикой конфиденциальности</a></small>
						<a href="#b-popup-success" class="b-thanks-link fancy" style="display:none;"></a>
					</div>
				</form>
				...
				<form action="thanks.php" method="POST" id="b-quiz-form">
					...
					<div data-number="1" class="b-quiz-container b-quiz-1" data-result="12">
						...
						<div class="b-quiz-left-col">
							<div class="b-popup-form">
								<label id="type-label" for="business">Хорошо. У меня бизнес в сфере:</label>
								<select name="type" id="type" data-placeholder="Выберите сферу бизнеса" required>
									<option selected disabled>Выберите сферу бизнеса</option>
					...
					<div data-number="4" class="b-quiz-container b-quiz-4" data-result="66" style="display: none">
						<h3><b>Скажите,</b> чего вы хотите в целом?</h3>
						<div class="b-quiz-left-col">
							<div class="b-popup-form">
					...
					<div data-number="5" class="b-quiz-container b-quiz-5 b-quiz-road-map" data-result="88">
						...
						<div class="b-quiz-left-col">
							<p>Нам нужно связаться с вами, чтобы уточнить пару моментов. Иначе ваша Road map будет типовой.</p>
					...
					<div data-number="5" class="b-quiz-container b-quiz-5 b-quiz-offer" data-result="88">
						...
						<div class="b-quiz-left-col">
							<p>Оставьте ваши контакты и получите предварительный расчёт окупаемости в excel + пошаговую «дорожную карту».</p>
		...
		<div class="b-popup" id="b-indexes-popup">
			<div class="b-note b-vertical-form">
				<div class="b-border">
