...
<body>
	<div class="b-thanks b-thanks-2" id="thanks-request">
		<div class="b-block b-thanks-header clearfix">
			<a href="/" class="b-thanks-back icon-arrow-left left">вернуться на сайт</a>
			<a href="/" class="b-logo left">
				<img src="i/1/logo@2x.png" alt="" width=106>
			</a>
			<div class="b-logo__text right">Агентство интернет-маркетинга</div>
		</div>
		<h2 class="anim fadeDown"><b>Отлично!</b> Мы уже получили вашу заявку</h2>
		<div class="b-block">
	...
	<div class="b-thanks-footer">
		<div class="b-block">
			<h2>Уже есть вопросы? <b>Напишите нам</b></h2>
			...
			<h2 class="b-goodbye anim fadeDown"><b>Удачного дня!</b></h2>
			<div class="b-bottom clearfix">
				<small class="b-copyright">© TFA 2018. Все права защищены</small>
				<div class="b-director">
					<div class="b-director-desc">
						<p class="anim fadeLeft"><b>Владимир Сургай</b></p>
